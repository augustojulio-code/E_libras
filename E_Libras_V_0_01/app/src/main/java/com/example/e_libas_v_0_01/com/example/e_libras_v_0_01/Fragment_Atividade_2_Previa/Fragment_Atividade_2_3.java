...
public class Fragment_Atividade_2_3 extends Fragment implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_02, new Fragment_Atividade_2_4());
            transaction.commit();
        }
    }
