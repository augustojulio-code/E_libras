...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_5_Previa.Fragment_Atividade_5_1;

public class Fragment_Atividade_6 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.cores_branco).into(gif_palavra);

        opcao01.setText("Azul");
        opcao02.setText("Preto");
        opcao03.setText("Branco");
        opcao04.setText("Verde");
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            Fragment_Atividade_6_1 fragment = new Fragment_Atividade_6_1();
