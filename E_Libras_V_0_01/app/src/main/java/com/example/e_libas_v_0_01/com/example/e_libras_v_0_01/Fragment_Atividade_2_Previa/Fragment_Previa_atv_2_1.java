...
public class Fragment_Previa_atv_2_1 extends Fragment implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
     if (view == btn_next)
     {
         ...
         transaction.replace(R.id.fragment_container_previa_Atividade_02, new Fragment_Previa_atv_2_2());
         transaction.commit();
     }
    }
}
