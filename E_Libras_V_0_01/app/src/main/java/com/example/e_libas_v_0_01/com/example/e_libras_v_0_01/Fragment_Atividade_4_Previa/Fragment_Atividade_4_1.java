...
public class Fragment_Atividade_4_1 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        img_letra.setImageResource(R.drawable.p);
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            Fragment_Atividade_4_2 fragment = new Fragment_Atividade_4_2();
