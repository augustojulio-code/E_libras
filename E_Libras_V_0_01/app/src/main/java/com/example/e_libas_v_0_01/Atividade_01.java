...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividades_01.Fragment_Atividade_Splash;
...
public class Atividade_01 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportFragmentManager().beginTransaction().replace
                (R.id.fragment_container_Atividade_01, new Fragment_Atividade_Splash()).commit();
