...
public class Fragment_Previa_6_3 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.cores_preto).into(gif);


        texto_txt.setText("Preto");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_06,new Fragment_Previa_6_4());
            transaction.commit();
        }
