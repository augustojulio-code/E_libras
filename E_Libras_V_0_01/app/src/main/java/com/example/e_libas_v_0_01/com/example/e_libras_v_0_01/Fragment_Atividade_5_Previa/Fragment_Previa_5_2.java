...
public class Fragment_Previa_5_2 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        letra.setImageResource(R.drawable.w);
        texto_txt.setText("W");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_05,new Fragment_Previa_5_3());
            transaction.commit();
        }
