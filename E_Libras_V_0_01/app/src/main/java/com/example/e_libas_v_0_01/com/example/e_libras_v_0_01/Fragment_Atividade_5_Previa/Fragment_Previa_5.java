...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_4_Previa.Fragment_Previa_4_1;

public class Fragment_Previa_5 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        letra.setImageResource(R.drawable.t);
        texto_txt.setText("T");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_05,new Fragment_Previa_5_1());
            transaction.commit();
        }
