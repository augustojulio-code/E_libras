...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_2_Previa.Fragment_Previa_atv_2_1;

public class Fragment_Previa_atv_3 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        letra.setImageResource(R.drawable.h);
        texto_txt.setText("H");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_03,new Fragment_Previa_3_1());
            transaction.commit();
        }
