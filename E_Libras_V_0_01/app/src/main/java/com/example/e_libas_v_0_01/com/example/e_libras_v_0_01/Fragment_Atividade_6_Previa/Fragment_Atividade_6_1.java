...
public class Fragment_Atividade_6_1 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.cores_amarelo).into(gif_palavra);

        opcao01.setText("Azul");
        opcao02.setText("Amarelo");
        opcao03.setText("Verde");
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            Fragment_Atividade_6_2 fragment = new Fragment_Atividade_6_2();
