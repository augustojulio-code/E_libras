...
public class Fragment_Previa_7_4 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.animais_jacare).into(gif);


        texto_txt.setText("Jacaré");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_07,new Fragment_Atividade_7_Splash());
            transaction.commit();
        }
