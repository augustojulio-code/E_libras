...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_5_Previa.Fragment_Atividade_5;

public class Fragment_Atividade_6_Splash extends Fragment
{
    ImageView gif;
    ...
    public void onStart()
    {
        ...
        new Handler().postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                ...
                transaction.replace(R.id.fragment_container_previa_Atividade_06,new Fragment_Atividade_6());
                transaction.commit();
            }
        },3500);
    }
