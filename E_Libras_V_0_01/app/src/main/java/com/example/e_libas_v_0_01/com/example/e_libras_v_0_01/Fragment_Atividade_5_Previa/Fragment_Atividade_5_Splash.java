...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_4_Previa.Fragment_Previa_atv_4;

public class Fragment_Atividade_5_Splash extends Fragment
{
    ImageView gif;
    ...
    public void onStart()
    {
        ...
        new Handler().postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                ...
                transaction.replace(R.id.fragment_container_previa_Atividade_05,new Fragment_Atividade_5());
                transaction.commit();
            }
        },3500);
    }
