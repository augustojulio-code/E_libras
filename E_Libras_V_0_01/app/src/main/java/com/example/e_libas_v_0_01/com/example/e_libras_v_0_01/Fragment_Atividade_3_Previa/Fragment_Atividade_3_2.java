...
public class Fragment_Atividade_3_2 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        img_letra.setImageResource(R.drawable.h);
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_03, new Fragment_Atividade_3_3());
            transaction.commit();
        }
    }
