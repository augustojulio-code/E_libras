...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_3_Previa.Fragment_Atividade_3_1;

public class Fragment_Atividade_4 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        img_letra.setImageResource(R.drawable.q);
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            Fragment_Atividade_4_1 fragment = new Fragment_Atividade_4_1();
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_04, fragment);
            transaction.commit();
        }
    }
