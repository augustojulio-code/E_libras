...
public class Fragment_Previa_4_1 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        letra.setImageResource(R.drawable.p);
        texto_txt.setText("P");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_04,new Fragment_Previa_4_2());
            transaction.commit();
        }
