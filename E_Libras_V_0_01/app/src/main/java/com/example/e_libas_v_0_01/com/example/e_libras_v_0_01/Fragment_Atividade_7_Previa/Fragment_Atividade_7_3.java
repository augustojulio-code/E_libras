...
public class Fragment_Atividade_7_3 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.animais_cachorro).into(gif_palavra);

        opcao01.setText("Jacaré");
        opcao02.setText("Cachorro");
        opcao03.setText("Elefante");
        opcao04.setText("Coelho");
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            Fragment_Atividade_7_4 fragment = new Fragment_Atividade_7_4();
