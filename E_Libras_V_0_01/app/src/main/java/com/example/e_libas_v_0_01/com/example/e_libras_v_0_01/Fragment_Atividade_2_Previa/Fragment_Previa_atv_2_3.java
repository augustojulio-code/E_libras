...
public class Fragment_Previa_atv_2_3 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        img_letra.setImageResource(R.drawable.f);
        txt_letra.setText("F");
    ...
    public void onClick(View view)
    {
        if (view == btn_next)
        {
            ...
            transaction.replace(R.id.fragment_container_previa_Atividade_02, new Fragment_Previa_atv_2_4());
            transaction.commit();
        }
