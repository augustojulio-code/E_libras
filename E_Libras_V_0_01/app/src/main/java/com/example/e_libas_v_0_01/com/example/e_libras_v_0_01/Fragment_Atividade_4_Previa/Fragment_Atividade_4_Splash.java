...
import com.example.e_libas_v_0_01.com.example.e_libras_v_0_01.Fragment_Atividade_3_Previa.Fragment_Atividade_3;

public class Fragment_Atividade_4_Splash extends Fragment
{
    ImageView gif;
    @Nullable
    @Override
    ...
    public void onStart()
    {
        ...
        new Handler().postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                ...
                transaction.replace(R.id.fragment_container_previa_Atividade_04, new Fragment_Atividade_4());
                transaction.commit();
            }
        },3500);
    }
