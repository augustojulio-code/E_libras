...
public class Fragment_Atividade_6_3 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.cores_verde).into(gif_palavra);

        opcao01.setText("Azul");
        opcao02.setText("Verde");
        opcao03.setText("Branco");
        opcao04.setText("Preto");
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next)
        {
            ...
            Fragment_Atividade_6_4 fragment = new Fragment_Atividade_6_4();
